...
<head>
    ...
    <!-- EDIT: Add a title. -->
    <title>How many events from the 2018 Winter Olympics can you name?</title>
...
<h2>
    How many events from the 2018 Winter Olympics can you name?
</h2>
...
<script>
var quiz_config = { 
        title: 'How many events from the 2018 Winter Olympics can you name?',
        slug: 'winter-olympics-2018-events',
        log_url: '../handler.php',
        has_photos: 1,
        log_answers: 1,
    };
