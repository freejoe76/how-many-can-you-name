...
<head>
    ...
    <!-- EDIT: Add a title. -->
    <title>How many overall No. 1 picks in the NFL Draft since 1996 can you name?</title>
...
<h2>
    How many overall No. 1 picks in the NFL Draft since 1996 can you name in two minutes?
</h2>
...
<input id="answer_key" type="hidden" value="Jared Goff,Jameis Winston,Jadeveon Clowney,Eric Fisher,Andrew Luck,Cam Newton,Sam Bradford,Matthew Stafford/Matt Stafford,Jake Long,JaMarcus Russell,Mario Williams,Alex Smith,Eli Manning,Carson Palmer,David Carr,Michael Vick,Courtney Brown,Tim Couch,Peyton Manning,Orlando Pace,Keyshawn Johnson" />
<!-- EDIT: Add the quiz-specific configuration values. -->
<script>
var quiz_config = { 
        title: 'How many overall No. 1 picks in the NFL Draft since 1996 can you name in two minutes?',
        slug: 'nfl-draft-picks-2017',
        log_url: '../handler.php',
        has_photos: 1,
        log_answers: 1,
    };
