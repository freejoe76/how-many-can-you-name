...
<head>
    ...
    <!-- EDIT: Add a title. -->
    <title>How many Queens neighborhoods can you name in ten minutes?</title>
...
<input id="time_limit" type="hidden" value="10" />
<!-- EDIT: Put the answers here, separated by commas, like this: value="Name1,Name2,Name3,Name4" -->
<input id="answer_key" type="hidden" value="Arverne,Astoria,Astoria Htens,Auburndale,Bay Terrace,Bayside,Bayswater,Beechhurst,Bellaire,Belle Harbor,Bellerose,Blissville,Breezy Point,Briarwood,Broad Channel,Brookville,Cambria Htens,Clearview,College Point,Corona,Corona Htens,Douglaston,Downtown Flushing,Dutch Kills,Edgemere,Elmhurst,Far Rockaway,Floral Park,Flushing,Forest Hills,Forest Hills Gardens,Fresh Meadows,Glen Oaks,Glendale,Hammels,Hillcrest,Hollis,Hollis Hills,Holliswood,Howard Beach,Hunters Point,Jackson Htens,Jamaica,Jamaica Center,Jamaica Estates,Jamaica Hills,Kew Gardens,Kew Gardens Hills,Laurelton,Lefrak City,Lindenwood,Little Neck,Long Island City,Malba,Maspeth,Middle Village,Murray Hill,Neponsit,New Hyde Park,North Corona,North Springfield Gardens,Oakland Gardens,Old Howard Beach,Ozone Park,Pomonok,Queensbridge,Queens Village,Queensboro Hill,Ravenswood,Rego Park,Richmond Hill,Ridgewood,Rochdale,Rockaway Park,The Rockaways,Rosedale,Roxbury,Seaside,Somerville,South Jamaica,South Ozone Park,Springfield Gardens,St. Albans,Steinway,Sunnyside,Sunnyside Gardens,Utopia,Waldheim,Whitestone,Woodhaven,Woodside" />
<!-- EDIT: Add the quiz-specific configuration values. -->
<script>
var quiz_config = { 
        title: 'How many Queens neighborhoods can you name in ten minutes',
...
if ( is_mobile() === 1 ) quiz_config.has_photos = 0;
    ...
    <form name="time_count">
        <input id="timer" type="text" readonly="true" value="10:00" name="timer" />
    </form>
