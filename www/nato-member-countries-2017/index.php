...
<head>
    ...
    <!-- EDIT: Add a title. -->
    <title>How many of NATO's 28 member countries can you name in three minutes?</title>
...
<h2>
    How many of NATO's 28 member countries can you name in three minutes?
</h2>
...
<!-- EDIT: If you want to give the people more or less than three minutes, edit this. --> 
...
<input id="answer_key" type="hidden" value="Albania,Belgium,Bulgaria,Canada,Croatia,Czech Republic,Denmark,Estonia,France,Germany,Greece,Hungary,Iceland,Italy,Latvia,Lithuania,Luxembourg,Netherlands,Norway,Poland,Portugal,Romania,Slovakia,Slovenia,Spain,United Kingdom/UK,United States/USA,Turkey" />
<!-- EDIT: Add the quiz-specific configuration values. -->
<script>
var quiz_config = { 
        title: 'How many of NATO\'s 28 member countries can you name in three minutes',
        slug: 'nato-member-countries-2017',
        log_url: '../handler.php',
        has_photos: 0,
        log_answers: 1,
    };
