...
.photos li span { width: 87px!important; }
    ...
    <but:ton class="btn-show-more-headlines" id="start-it" onClick="quizzer.start();">Start the quiz</button>
